...
- **CTAs (v2):** nav “Começar”, hero **Falar no WhatsApp** (desktop) + “Ver em 1 min” + “Começar agora”, formulário de lead, FAB WhatsApp (também no `/tour`; no mobile o hero não duplica o CTA) e “Seja revendedor” no rodapé. O FAB sobe com o banner de cookies e fica abaixo do chat do site, se os dois existirem.
