...
**Como funciona:**
- Cada conexão pode ser Baileys ou API Oficial
- Conexões Baileys: sessões são salvas em \`backend/private/sessions/\`
- Conexões API Oficial: autenticação via credenciais Meta
