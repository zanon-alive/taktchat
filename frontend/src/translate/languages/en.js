const messages = {
  ...
  undefined: "Queue not found",
		...
		helps: {
		  title: "Help Center",
		  entrySourceChatSite: {
			title: "EntrySource, Channels and Site Chat",
			intro: "This guide describes the origin tracking in tickets, configurable entry channels (Lead, Reseller, Site chat) and the embeddable chat widget for external sites.",
			entrySourceTitle: "EntrySource in Tickets",
			entrySourceDesc: "Each ticket has a field indicating the contact source: WhatsApp, Lead (landing form), Reseller (landing modal), Site chat (widget or API) or Channel (legacy).",
			entrySourceFilter: "In the tickets list, use the \"Channel\" filter to display only tickets from a specific source.",
			channelsTitle: "Entry Channels",
			channelsDesc: "Configure queue, tag, WhatsApp and welcome message for each channel.",
			channelsStep1: "Go to Settings > Entry channels",
			channelsStep2: "Select the channel (Lead, Reseller, Site chat)",
			channelsStep3: "Set default queue, tag, WhatsApp (optional) and welcome message. Use {{name}} to insert the contact name.",
			leadTitle: "Lead and Reseller Forms",
			leadDesc: "On the landing page (/landing): Lead form creates contact and ticket with entrySource 'lead'; \"Become a reseller\" modal creates ticket with entrySource 'revendedor'. If the contact already has an open ticket, an internal message is added instead of creating a new ticket.",
			chatTitle: "Site Chat",
			chatDesc: "Public API for visitors to start conversations from the site. Endpoints: POST /public/site-chat/submit (create ticket), POST /public/site-chat/message (send message), GET /public/site-chat/messages (list messages). Requires companyId or companyToken in the request body.",
			chatConfig: "The company plan must have \"Site Chat\" enabled (Settings > Plans). Platform-type companies do not require a plan.",
			widgetTitle: "Site Chat Widget",
			widgetDesc: "Embeddable JavaScript widget for any website. In Settings > Site Chat Widget, get the integration code and token (\"Get token\" button). The code can be pasted into external HTML pages.",
			widgetToken: "Use data-api-url in the script when the widget is on an external site (e.g. data-api-url=\"https://api.taktchat.com.br\").",
			docsRef: "Detailed documentation: .docs/funcionalidades/widget-chat-site.md",
		  },
		  settings: {
		...
		hideTicketModal: {
		  title: "Hide ticket",
		  message: "The ticket leaves the inbox. An admin can audit the conversation. Messages are not deleted.",
		  category: "Category",
		  reason: "Reason",
		  ...
		  categories: {
			duplicado: "Duplicate",
			teste: "Test",
			erro_abertura: "Opened by mistake",
			contato_pediu: "Contact requested deletion",
			lgpd: "LGPD",
			outro: "Other",
		  },
		},
		deletedTickets: {
		  ...
		  next: "Next",
		  back: "Back",
		  banner: "Hidden — cannot be reopened",
		...
		siteChatWidget: {
		  ...
		  info: "Configure and get the code to integrate the site chat widget on your website.",
		  authMethod: "Authentication method",
		  useCompanyId: "Use Company ID",
		  useCompanyToken: "Use Company Token",
		  authMethodHelp: "Choose how the widget will identify your company (ID or Token).",
		  companyId: "Company ID",
		  companyIdHelp: "Numeric ID of your company in the system.",
		  companyToken: "Company Token",
		  companyTokenHelp: "Company authentication token (more secure for public use). Click 'Get token' to generate.",
		  getToken: "Get token",
		  loadingToken: "Generating...",
		  tokenFetched: "Token generated successfully!",
		  tokenError: "Error getting token.",
		  embedCode: "Integration Code",
		  configureFirst: "Configure the Company ID or Token above to generate the code.",
		  copy: "Copy",
		  copied: "Copied!",
		  instructions: {
			title: "How to integrate:",
			step1: "Copy the code above",
			step2: "Paste the code before the closing </body> tag on all pages where you want to display the widget",
			step3: "The widget will automatically appear as a floating button in the bottom right corner",
			step4: "Visitors will be able to start conversations directly from your site",
		  },
		  important: "Important:",
		  importantNote: "Make sure the company plan has the 'Site Chat' feature enabled. The widget will only work if this option is active in the plan.",
		  apiUrl: "API URL",
