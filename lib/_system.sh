...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Flowlatest...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/Flowlatest.zip /home/deploy/${instancia_add}/
EOF
...
#   None
#######################################
system_unzip_Flowlatest() {
  print_banner
  printf "${WHITE} 💻 Extraindo o Flowlatest...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - deploy <<EOF
  unzip /home/deploy/${instancia_add}/Flowlatest.zip -d /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Flowlatest...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do Flowlatest...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Bloquear o Flowlatest...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Flowlatest de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do Flowlatest de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
