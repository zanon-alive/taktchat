...
| 2 | Contatos, tags e Kanban | [02-contatos-tags-kanban.md](02-contatos-tags-kanban.md) | Simulado + lanes PR #21 |
| 3 | Conexões WhatsApp | [03-conexoes-whatsapp.md](03-conexoes-whatsapp.md) | CONNECTED (Baileys) |
...
| 11 | Whitelabel e licenças | [11-whitelabel-licencas.md](11-whitelabel-licencas.md) | Simulado (type/parent/Licenses ok) |
...
2. Demanda 16 caminho B (CRM de mercado). O caminho A (quadro de conversas) já está no produto.
