...
| 2026-08-25 | 2.2.2v-26 | Correção pós-auditoria ao vivo: produção usa Swarm/Portainer e GHCR por digest; definição ativa no Portainer; YAML local classificado como referência não confirmada. | Equipe Dev |
| 2026-08-21 | 2.2.2v-26 | Registro histórico posteriormente corrigido em 25/08: a hipótese de `14_taktchat.yml` com volumes não corresponde à produção auditada. | Equipe Dev |
