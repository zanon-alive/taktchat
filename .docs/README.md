...
- `kit-produto/`: **kit por audiência (v1.5)** — catálogo, manuais por role, comercial/técnica, screenshots e player em `/apresentacoes`. Comece por `kit-produto/README.md`. Kanban alinhado ao PR #21; quadro lista `closed` com lane. Demanda restante (CRM A6–A9 / B): `kit-produto/16-demanda-crm-conversa-ou-mercado.md`.
